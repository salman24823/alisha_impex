...
export default function Carousel() {
  ...
  return (
    ...
    <Slider className="w-screen" {...settings}>
      <div className="relative w-full max-[770px]:!flex flex-col-reverse">
        <div className="slider_cont max-[770px]:!w-full img_cont p-[5%] w-[30%] md:h-full h-[500px] absolute max-[770px]:static z-10 flex flex-col gap-6">
          ...
          <p className="text-lg text-white ">Reactive dyes are a type of dye that chemically bond with fibers, especially cellulose and protein fibers, during the dyeing process. This strong bond ensures vibrant, long-lasting colors that are resistant to fading and washing. They are commonly used in textile industries for dyeing fabrics like cotton and wool.</p>
        </div>
      ...
      <div className="slider_cont max-[770px]:!w-full img_cont p-[5%] w-[30%] md:h-full h-[500px] absolute max-[770px]:static z-10 flex flex-col gap-6">
          ...
          <p className="text-lg text-white ">Disperse dyes are water-insoluble dyes primarily used for coloring synthetic fibers, such as polyester and nylon. They are finely ground and applied in a dispersed form, offering vibrant colors and good wash fastness.</p>
        </div>
