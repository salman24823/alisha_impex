...
const Aboutsection = () => {
  ...
  return (
    <main
      id="about"
      className="Main_cnt abt sections gap-10 overflow-hidden p-[5%] max-[770px]:text-center w-full min-h-[110vh] bg-[url(./../../public/about.png)] bg-cover bg-no-repeat  grid grid-cols-1 md:grid-cols-2  md:gap-32"
      data-aos="fade-up"
    >
      <div className="flex flex-col items-center gap-5 md:gap-4 md:col-span-2" data-aos="fade-right">
        ...
        <p className="para text-base text-center" data-aos="fade-up" data-aos-delay="300">
