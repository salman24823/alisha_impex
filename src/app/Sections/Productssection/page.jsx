  ...
  return (
    <div id="products" className="sections p-[5%] flex items-center flex-col gap-6">
      ...
      <div className="product_section grid md:grid-cols-3 grid-cols-1 gap-10">
        <div className="product_card card1 h-[430px] w-[19rem] bg-[url(./../../public/reactive.png)] bg-cover bg-no-repeat rounded-lg overflow-hidden">
        ...
        <div className="product_card card1 h-[430px] w-[19rem] bg-[url(./../../public/arcylic.png)] bg-cover bg-no-repeat rounded-lg overflow-hidden">
          <div className="card_content w-[100%] h-[100%] flex flex-col p-3 card_back text-white font-bold justify-between relative top-[88%]">
        ...
        <div className="product_card card1 h-[430px] w-[19rem] bg-[url(./../../public/sulphur.png)] bg-cover bg-no-repeat rounded-lg overflow-hidden">
          <div className="card_content w-[100%] h-[100%] flex flex-col p-3 card_back text-white font-bold justify-between relative top-[88%]">
        ...
        <div className="product_card card1 h-[430px] w-[19rem] bg-[url(./../../public/disperse.png)] bg-cover bg-no-repeat rounded-lg overflow-hidden">
          <div className="card_content w-[100%] h-[100%] flex flex-col p-3 card_back text-white font-bold justify-between relative top-[88%]">
        ...
        <div className="product_card card1 h-[430px] w-[19rem] bg-[url(./../../public/hpmc.png)] bg-cover bg-no-repeat rounded-lg overflow-hidden">
          <div className="card_content w-[100%] h-[100%] flex flex-col p-3 card_back text-white font-bold justify-between relative top-[88%]">
        ...
        <div className="product_card card1 h-[430px] w-[19rem] bg-[url(./../../public/direct.png)] bg-cover bg-no-repeat rounded-lg overflow-hidden">
          <div className="card_content w-[100%] h-[100%] flex flex-col p-3 card_back text-white font-bold justify-between relative top-[88%]">
